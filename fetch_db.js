async function run() {
    const res = await fetch("https://curyufedazpkhtxrwhkn.supabase.co/rest/v1/tasks?select=id,title,start_date,due_date,created_at,parent_task_id&order=created_at.desc&limit=25", {
        headers: {
