const url = "https://curyufedazpkhtxrwhkn.supabase.co/rest/v1/tasks?title=eq.[Rotina]%20Check%20de%20Disponibilidade&select=id,status,due_date,start_date,parent_task_id,unit_id,created_at&order=due_date.desc&limit=10";
const headers = {
